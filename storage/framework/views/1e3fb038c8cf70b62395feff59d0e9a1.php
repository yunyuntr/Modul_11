...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            <a href="<?php echo e(url('/portofolio')); ?>" class="list-group-item list-group-item-action">
                Portofolio
            </a>
        </div>
    </div>
...
<?php /**PATH C:\xampp2\htdocs\laravel-modul 11\latihan\resources\views/routing.blade.php ENDPATH**/ ?>