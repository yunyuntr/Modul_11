        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid half-circle" src="<?php echo e(Vite::asset('/resources/Images/profil.jpg')); ?>"
                        alt="main logo">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <a href="#" class="work-box">
                    <img class="work-image" src="<?php echo e(Vite::asset('/resources/Images/infografis.png')); ?>"
                        alt="Infografis">
                ...
                <a href="#" class="work-box">
                    <img class="work-image" src="<?php echo e(Vite::asset('/resources/Images/pim.jpg')); ?>" alt="PIM">
                    <div class="work-description">
                        <h4>PIM</h4>
                ...
                <a href="#" class="work-box">
                    <img class="work-image" src="<?php echo e(Vite::asset('/resources/Images/innovillage.png')); ?>"
                        alt="UI Innovillage">
                    <div class="work-description">
...
<?php /**PATH C:\xampp2\htdocs\laravel-modul 11\latihan\resources\views/portofolio.blade.php ENDPATH**/ ?>